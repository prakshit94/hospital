...
class EmployeeHealthRecordController extends Controller
{
    ...
    private function getValidationRules(): array
    {
        return [
            ...
            'near_vision_right_without' => 'nullable|string|max:5000',
            'near_vision_left' => 'nullable|string|max:5000',
            'near_vision_left_without' => 'nullable|string|max:5000',
            'distant_vision_right' => 'nullable|string|max:5000',
            'distant_vision_right_without' => 'nullable|string|max:5000',
            'distant_vision_left' => 'nullable|string|max:5000',
            'distant_vision_left_without' => 'nullable|string|max:5000',
