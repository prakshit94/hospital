    ...
    <x-ui.card class="space-y-6">
        <div>
            ...
            <p class="section-copy">
                Create a granular system capability that can be attached to roles and reused across the workspace.
            </p>
        </div>
    ...
    <div class="space-y-6">
        ...
        <x-ui.card class="space-y-4">
            <div>
                ...
                <p class="section-copy">
                    A strong permission model reads well in logs, exports, and role assignment screens.
                </p>
            </div>
        ...
        <x-ui.card class="space-y-3">
            ...
            @if($modalMode ?? false)
                <button 
                    type="button" 
                    data-modal-close 
                    class="inline-flex w-full items-center justify-center gap-2 rounded-[1.2rem] border border-border bg-secondary px-4 py-2.5 text-sm font-semibold text-foreground transition duration-300 active:scale-[0.98] hover:bg-accent"
                >
                    Cancel
                </button>
            @else
