...
<html lang="en">
   ...
   <body>
      @php $dob = $record->dob ? $record->dob->format('d-m-Y') : 'N/A'; $age = $record->dob ? (int) $record->dob->diffInYears(now()) : 'N/A'; $examDate = $record->examination_date ? $record->examination_date->format('d/m/Y') : 'N/A'; $extensionDate = $record->examination_date ? $record->examination_date->copy()->addMonths(6)->format('d/m/Y') : 'N/A'; $isFit = strtoupper($record->health_status ?? '') === 'FIT';@endphp
      <div class="page">
         <div class="header">
            <h1>Form No. 33</h1>
