    ...
    <section class="hero-panel">
        <div class="grid gap-8 xl:grid-cols-[minmax(0,1.4fr)_minmax(320px,0.8fr)] xl:items-center">
            ...
            <div>
                ...
                <p class="hero-copy">
                    Monitor access, recent activity, and account changes from one place.
                </p>

                <!-- Actions -->
                <div class="hero-actions">
                    @can('users.create')
                        <x-ui.button variant="secondary" href="{{ route('users.create') }}" data-modal-open>
                            Create User
                        </x-ui.button>
                    @endcan
                    ...
                    <div class="mt-3 space-y-3">
                        @forelse($activities->take(2) as $activity)
                            <div class="list-card">
                                ...
                                <div class="mt-1 text-xs font-black uppercase tracking-[0.18em] text-muted-foreground">
            ...
            <div class="section-header">
                <div>
                    ...
                    <p class="section-copy">
                        Latest sign-ins and administrative changes.
                    </p>
                </div>

                <x-ui.button variant="ghost" href="{{ route('activity-logs.index') }}">
                    Open Log
                </x-ui.button>
            </div>
        ...
        <x-ui.card>
            <div class="section-header">
                <div>
                    ...
                    <p class="section-copy">
                        Recently added users and their assigned roles.
                    </p>
                </div>
            </div>
